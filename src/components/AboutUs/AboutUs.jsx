...
export default function AboutUs() {
  return (
    <section class=" text-center container">
      <h2 class="p-3" id="about_us">About us</h2>

      <div className='vision text-start row align-items-center mb-5 bg-vc_btn-success'>
      ...
      {/* massage */}
      <div className='vision text-end row flex-row-reverse align-items-center mb-5'>
        <div className="content col-12 col-md-6">
